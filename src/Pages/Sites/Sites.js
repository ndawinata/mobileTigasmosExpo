...
import { Button, ImageBackground, Picker, ScrollView, StyleSheet, Text, View } from 'react-native';
import { BGUtama } from '../../Assets';
import { SitesBox } from '../../Component';
                ...
                <View style={styles.container}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <View style={styles.container3}>
                            <Button color="#162447" title="Data Tabel" onPress={()=>props.navigation.navigate('Tabel')} />
                        </View>
                    </ScrollView>
                </View>
            </ImageBackground>
